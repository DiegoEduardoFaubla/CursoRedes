...
with st.container():
    ...
    with left_column:
        ...
        with st.expander("Módulos 13-17"):
            ...
            st.write("Módulo 14: Capa de Transporte")
            st.write("Módulo 15: Capa de Aplicación")
...
with st.container():
    ...
    with left_column:
        ...
        st.subheader("Estudiante de Ing en Electrónica, Telecomunicaciones y Redes en la ESPOCH")
        st.info("Secretario de la Rama IEEE Computer Society ESPOCH")
